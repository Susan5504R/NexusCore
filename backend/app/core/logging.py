"""Structured JSON logging for Nexus-Core.
...
``configure_logging()`` once at startup, then ``logging.getLogger("nexuscore")``
anywhere in the app.
...
def configure_logging(level: int = logging.INFO) -> logging.Logger:
    """Configure the 'nexuscore' logger to emit JSON to stdout. Idempotent."""
